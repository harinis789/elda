...
const Login = () => {
    ...
    const onSubmit = (data) => {
        ...
        localStorage.setItem('user', JSON.stringify({ name: 'Demo User', email: data.email, role: 'user' }));
        navigate('/shop');
    };
        ...
        <div className="flex h-screen w-full">
            ...
            <div className="hidden lg:flex w-1/2 relative overflow-hidden bg-primary">
                ...
                <div className="relative z-20 flex items-center justify-center w-full h-full">
                    ...
                    >
                        <h1 className="text-6xl font-serif font-bold mb-4">Nature's Gold</h1>
                        <p className="text-xl font-light tracking-widest">PURE . ETHICAL . TIMELESS</p>
                    </motion.div>
                </div>
            </div>
